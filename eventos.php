...
<head>
	<meta charset="UTF-8"/>
	<title>Eventos Diocesanos | Renovação Carismática Católica &amp; Diocese Divinópolis</title>
...
<div class="boxed-container">
	...
	<div class="main-title" style="background-color: #f2f2f2; ">
		<div class="container">
			<h1 class="main-title__primary">EVENTOS DIOCESANOS</h1>
			<h3 class="main-title__secondary">Acompanha os eventos da nossa Diocese.</h3>
		</div>
	</div>
	<div class="breadcrumbs breadcrumbs--page-builder">
		<div class="container">
			...
			<span typeof="v:Breadcrumb"><span property="v:title"><a>Eventos</a></span></span>
			<span typeof="v:Breadcrumb"><span property="v:title">Eventos</span></span>	
		</div>
	</div>
