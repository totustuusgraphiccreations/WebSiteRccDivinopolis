...
<head>
	<meta charset="UTF-8"/>
	<title>Ministérios | Renovação Carismática Católica &amp; Diocese Divinópolis</title>
...
<div class="boxed-container">
	...
	<div class="main-title" style="background-color: #f2f2f2; ">
		<div class="container">
			<h1 class="main-title__primary">MINISTÉRIOS</h1>
			<h3 class="main-title__secondary">Conheça um pouco mais sobre os ministérios.</h3>
		</div>
	</div>
