...
<head>
	...
	<link href="css/organograma.css" rel="stylesheet">
...
<div class="boxed-container">
	...
	<div class="main-title" style="background-color: #f2f2f2; ">
		<div class="container">
			<h1 class="main-title__primary">CONSELHO DIOCESANO</h1>
			<h3 class="main-title__secondary"><strong>Equipe de coordenação da </strong> Renovação Carismática Católica - Diocese Divinópolis</h3>
		</div>
	</div>
	<div class="breadcrumbs ">
		<div class="container">
			<span typeof="v:Breadcrumb"><a rel="v:url" property="v:title" title="Go to BuildPress." href="index.php" class="home">Renvação Carismática Católica - Diocese Divinópolis</a></span>
			<span typeof="v:Breadcrumb"><span property="v:title"><a>Institucional</a></span></span>
			<span typeof="v:Breadcrumb"><span property="v:title">Conselho Diocesano</span></span>
		</div>
	</div>
<div class="tl-wrapper">		
  <ul class="timeline">
	<?php
		$Conn_tbconcelhodiocesano = new ConnectionDB();
		$SqlQuery_tbconcelhodiocesano = "SELECT * FROM tbconcelhodiocesano";
		$result_tbconcelhodiocesano = $Conn_tbconcelhodiocesano->connect()->query($SqlQuery_tbconcelhodiocesano);				
		//Tabela CONCELHO DIOCESANO			
		while($row_tbconcelhodiocesano = $result_tbconcelhodiocesano->fetch_assoc()){
			$idtbconcelhodiocesano = $row_tbconcelhodiocesano['idtbconcelhodiocesano'];
			$idtbcontact = $row_tbconcelhodiocesano['idtbcontact'];
			$idtypecoordination =  $row_tbconcelhodiocesano['idtypecoordination'];
		//Tabela GET NOME CONTATO	
			$Conn_tbcontact = new ConnectionDB();
			$SqlQuery_tbcontact = "SELECT * FROM tbcontact WHERE idtbcontact = '$idtbcontact'";
			$result_tbcontact = $Conn_tbcontact->connect()->query($SqlQuery_tbcontact);
				while($row_tbcontact = $result_tbcontact->fetch_assoc()){
					$nametbcontact = $row_tbcontact['nametbcontact'];
					$nametbcontactstring=$nametbcontact;
					$nametbcontactstring=explode(" ", $nametbcontactstring);
					
				}
		
	  ?>  
    <li class="tl-item" data-year="<? echo $nametbcontactstring[0]?>">
     	<div class="box">
                <img  src="images/demo/content/banner_content.jpg">
                <div class="box-content_timeline">
                    <h3 class="title_timeline"><?php echo $nametbcontact;?></h3>
                    <span class="post_timeline">Presinte do Conselho Diocesano</span>
                </div>
                <ul class="icon_timeline">
                    <li><a><i class="fa fa-phone"></i></a></li>
					<span>+5537991979280</span>
                </ul>
				<ul class="icon_timeline1">
                    <li><a><i class="fa fa-envelope"></i></a></li>
					<span>coordenacao@rccdivinopolis.com.br</span>
                </ul>
        </div>
	  </li>
	  <?php } ?>
...
<script type="text/javascript" src="js/organograma.js"></script>
