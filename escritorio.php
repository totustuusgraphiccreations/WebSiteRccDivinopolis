...
<head>
	<meta charset="UTF-8"/>
	<title>Escrítorio Diocesano | Renovação Carismática Católica &amp; Diocese Divinópolis</title>
...
<div class="boxed-container">
	...
	<div class="main-title" style="background-color: #f2f2f2; ">
		<div class="container">
			<h1 class="main-title__primary">ESCRÍTORIO DIOCESANO</h1>
			<h3 class="main-title__secondary">Estamos aqui a sua disposição, para melhor atende-lo.</h3>
		</div>
	</div>
	<div class="breadcrumbs breadcrumbs--page-builder">
		<div class="container">
			...
			<span typeof="v:Breadcrumb"><span property="v:title">Escrítorio Diocesano</span></span>	
		</div>
	</div>
			...
			<div class="row">
				<main class="col-xs-12  col-md-9" role="main">
					<article class="post tformat-standard hentry">
						<a href="#">
							<img width="848" height="480" src="images/demo/rcc/em-construcao.png" class="img-responsive wp-post-image" alt="Project Image"/>	
						</a>
					</article>
				</main>
			</div>
