...
<head>
	<meta charset="UTF-8"/>
	<title>Amigos da RCC | Renovação Carismática Católica &amp; Diocese Divinópolis</title>
...
<div class="boxed-container">
	...
	<div class="main-title" style="background-color: #f2f2f2; ">
		<div class="container">
			<h1 class="main-title__primary">AMIGOS DA RCC</h1>
			<h3 class="main-title__secondary">Venha fazer parte dos Amigos da RCC</h3>
		</div>
	</div>
	<div class="breadcrumbs breadcrumbs--page-builder">
		<div class="container">
			...
			<span typeof="v:Breadcrumb"><span property="v:title">Amigos da RCC</span></span>	
		</div>
	</div>
